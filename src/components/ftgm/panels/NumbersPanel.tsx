...
/** "Mis números": stock health per product, measured against the AI's forecast. */
      ...
      <PanelHeading
        ...
        description={
          expert
            ...
            : "Cómo está el stock de cada producto, comparado con lo que la IA calcula que vas a vender."
        }
        action={
      ...
      {expert ? (
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
          ...
          <MetricCard
            ...
            onClick={running && onGoToBuy ? onGoToBuy : undefined}
          />
          <MetricCard
            icon={PiggyBank}
            accent="warning"
      ...
      <DataState
        ...
        emptyState={
          <EmptyState
            ...
            description="Aparecen solos cuando la IA calcula cuánto venderás. También puedes actualizarlos con el botón."
            action={onNewRun ? { label: "Predecir con IA", onClick: onNewRun } : { label: "Predecir con IA", href: "/forecasting" }}
          />
        }
      >
  ...
  return (
    <Card className="flex flex-col gap-4">
      ...
      <div className="mt-auto rounded-xl bg-surface-soft px-3 py-2 text-xs text-text-secondary">
        ...
        {todo}
        {onClick && (
          <button type="button" onClick={onClick} className="ml-1 font-semibold text-accent-violet hover:opacity-80">
            Ir ahora →
          </button>
        )}
      </div>
