...
/** "Qué comprar": the buy list the AI builds by crossing its forecast with your stock. */
export function BuyPanel({ companyId, onNewRun }: { companyId: string | null; onNewRun?: () => void }) {
      ...
      <PanelHeading
        ...
        description={
          expert
            ...
            : "La lista de lo que te conviene comprar, según tu stock y lo que la IA calcula que vas a vender."
        }
        action={
      ...
      <DataState
        ...
        emptyState={
          <EmptyState
            ...
            description="La lista se arma sola cada vez que la IA calcula cuánto venderás (también con un solo producto)."
